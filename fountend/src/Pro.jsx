...
const isValidUTR = utrRegex.test(txnId);
  ...
  const proFeatures = [
    { icon: <Zap size={20} />, text: "5 quiz per day" },
    { icon: <Star size={20} />, text: "AI feature" },
    { icon: <Shield size={20} />, text: "Advanced Question" },
    { icon: <Sparkles size={20} />, text: "Flexible interface" }
  ];
